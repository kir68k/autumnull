...
theme.set_highlights = function()
  ...
  hl(0, "WinSeparator", { fg = c.gray, bg = 'NONE', })
  ...
  hl(0, "WildMenu", { fg = c.fg, bg = c.ui2_purple, })
  ...
  hl(0, "Visual", { fg = c.ui2_purple, bg = c.dark, })
  ...
  hl(0, "QuickFixLine", { fg = 'NONE', bg = c.ui2_purple, })
  hl(0, "Pmenu", { fg = c.fg, bg = c.alt_bg, })
  hl(0, "PmenuSel", { fg = 'NONE', bg = c.line, })
  ...
  -- Cmp
  hl(0, "CmpItemMenu", { fg = 'NONE', bg = c.alt_bg, italic=true, })
  hl(0, "CmpItemAbbrDeprecated", { fg = c.gray, bg = 'NONE', strikethrough=true, })
  hl(0, "CmpItemAbbrMatch", { fg = c.ui3_purple, bg = 'NONE', })
  hl(0, "CmpItemKindFunction", { fg = c.red, bg = 'NONE', })
  hl(0, "CmpItemKindMethod", { fg = c.red, bg = 'NONE', })
  hl(0, "CmpItemKindConstructor", { fg = c.purple, bg = 'NONE', })
  hl(0, "CmpItemKindClass", { fg = c.purple, bg = 'NONE', })
  hl(0, "CmpItemKindEnum", { fg = c.purple, bg = 'NONE', })
  hl(0, "CmpItemKindEvent", { fg = c.yellow, bg = 'NONE', })
  hl(0, "CmpItemKindInterface", { fg = c.red, bg = 'NONE', })
  hl(0, "CmpItemKindStruct", { fg = c.red, bg = 'NONE', })
  hl(0, "CmpItemKindVariable", { fg = c.orange, bg = 'NONE', })
  hl(0, "CmpItemKindField", { fg = c.orange, bg = 'NONE', })
  hl(0, "CmpItemKindProperty", { fg = c.orange, bg = 'NONE', })
  hl(0, "CmpItemKindEnumMember", { fg = c.orange, bg = 'NONE', })
  hl(0, "CmpItemKindConstant", { fg = c.light_red, bg = 'NONE', })
  hl(0, "CmpItemKindKeyword", { fg = c.light_red, bg = 'NONE', })
  hl(0, "CmpItemKindModule", { fg = c.purple, bg = 'NONE', })
  ...
  hl(0, "IndentBlanklineContextStart", { fg = c.yellow, bg = 'NONE', italic=true, })
  ...
  hl(0, "DiagnosticSignInformation", { fg = c.info_purple, bg = 'NONE', })
  hl(0, "DiagnosticSignInfo", { fg = c.info_purple, bg = 'NONE', })
  hl(0, "DiagnosticSignHint", { fg = c.hint_yellow, bg = 'NONE', })
  hl(0, "LspDiagnosticsDefaultError", { fg = c.error_red, bg = 'NONE', })
  hl(0, "LspDiagnosticsDefaultWarning", { fg = c.warning_orange, bg = 'NONE', })
  hl(0, "LspDiagnosticsDefaultInformation", { fg = c.info_purple, bg = 'NONE', })
  hl(0, "LspDiagnosticsDefaultInfo", { fg = c.info_purple, bg = 'NONE', })
  hl(0, "LspDiagnosticsDefaultHint", { fg = c.hint_yellow, bg = 'NONE', })
  hl(0, "LspDiagnosticsSignError", { fg = c.error_red, bg = 'NONE', })
  hl(0, "LspDiagnosticsSignWarning", { fg = c.warning_orange, bg = 'NONE', })
  hl(0, "LspDiagnosticsSignInformation", { fg = c.info_purple, bg = 'NONE', })
  hl(0, "LspDiagnosticsSignInfo", { fg = c.info_purple, bg = 'NONE', })
  hl(0, "LspDiagnosticsSignHint", { fg = c.hint_yellow, bg = 'NONE', })
  hl(0, "LspDiagnosticsError", { fg = c.error_red, bg = 'NONE', })
  hl(0, "LspDiagnosticsWarning", { fg = c.warning_orange, bg = 'NONE', })
  hl(0, "LspDiagnosticsInformation", { fg = c.info_purple, bg = 'NONE', })
  hl(0, "LspDiagnosticsInfo", { fg = c.info_purple, bg = 'NONE', })
  hl(0, "LspDiagnosticsHint", { fg = c.hint_yellow, bg = 'NONE', })
  ...
  hl(0, "LspDiagnosticsVirtualTextInformation", { fg = c.info_purple, bg = 'NONE', })
  hl(0, "LspDiagnosticsVirtualTextInfo", { fg = c.info_purple, bg = 'NONE', })
  hl(0, "LspDiagnosticsVirtualTextHint", { fg = c.hint_yellow, bg = 'NONE', })
  hl(0, "LspDiagnosticsFloatingError", { fg = c.error_red, bg = 'NONE', })
  hl(0, "LspDiagnosticsFloatingWarning", { fg = c.warning_orange, bg = 'NONE', })
  hl(0, "LspDiagnosticsFloatingInformation", { fg = c.info_purple, bg = 'NONE', })
  hl(0, "LspDiagnosticsFloatingInfo", { fg = c.info_purple, bg = 'NONE', })
  hl(0, "LspDiagnosticsFloatingHint", { fg = c.hint_yellow, bg = 'NONE', })
  ...
  hl(0, "NvimTreeGitignoreIcon", { fg = c.light_red, bg = 'NONE', })
  ...
  hl(0, "NvimTreeOpenedFolderName", { fg = c.folder_blue, bg = 'NONE', italic=true, bold=true, })
  ...
  hl(0, "StatusLineNC", { fg = c.dark, bg = c.line, })
  hl(0, "StatusLineSeparator", { fg = c.line, bg = 'NONE', })
  hl(0, "StatusLineTerm", { fg = c.line, bg = 'NONE', })
  hl(0, "StatusLineTermNC", { fg = c.line, bg = 'NONE', })

  -- Telescope
  hl(0, "TelescopeSelection", { fg = c.hint_yellow, bg = 'NONE', })
  hl(0, "TelescopeMatching", { fg = c.info_purple, bg = 'NONE', bold=true, })
  hl(0, "TelescopeBorder", { fg = c.purple, bg = c.bg, })
  ...
  hl(0, "TSCharacter", { fg = c.yellow, bg = 'NONE', })
  ...
  hl(0, "TSException", { fg = c.warning_orange, bg = 'NONE', })
  hl(0, "TSField", { fg = c.fg, bg = 'NONE', })
  hl(0, "TSFloat", { fg = c.purple, bg = 'NONE', })
  hl(0, "TSFuncBuiltin", { fg = c.light_red, bg = 'NONE', })
  hl(0, "TSFuncMacro", { fg = c.light_red, bg = 'NONE', })
  ...
  hl(0, "TSStructure", { fg = c.red, bg = 'NONE', })
  hl(0, "TSSymbol", { fg = c.red, bg = 'NONE', })
  ...
  hl(0, "TSVariable", { fg = c.light_red, bg = 'NONE', })
